...
const RelatedFilm = ({ relatedFilm }: { relatedFilm: Film[] }) => {
			...
			<div className="relative flex items-center justify-between px-2">
				<div className="flex flex-col">
					...
					>
						...
						<h2 className="text-2xl font-black italic uppercase tracking-tighter text-white md:text-3xl">
							Các phần{" "}
					...
					<motion.p
						...
						className="ml-11 mt-1 text-[10px] font-bold uppercase tracking-[0.3em] text-white/30"
					>
				...
				<motion.div
					initial={{ scale: 0 }}
					whileInView={{ scale: 1 }}
					className="hidden md:flex h-10 w-10 items-center justify-center rounded-full border border-white/5 bg-white/2 font-mono text-xs font-bold text-purple-400 backdrop-blur-sm"
				>
					{relatedFilm.length}
				</motion.div>
			</div>
