...
// --- GENERATE METADATA CHO ĐẠI LỤC (QUỐC GIA) ---
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	const description = `Tổng hợp những bộ phim ${countryName} chọn lọc nhất. Khám phá kho tàng điện ảnh từ đại lục ${countryName} tại hệ thống Tu Phim.`
...
export default async function CountryPage({ params }: Props) {
	...
	// Định nghĩa kiểu cho 'c' để tránh lỗi 'any'
	const currentCountry = countries.find(
		(c: { slug: string; name: string }) => c.slug === slug,
	)
